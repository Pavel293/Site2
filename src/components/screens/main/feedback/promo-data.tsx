...
export const propoData = [
	{
		...
		description: (
			<>
				“Отличное владение английским языком на уровне B1, глубоко понимаю
				грамматику и лексику. Помогу Вашему ребенку с домашним заданием, повышу
				его успеваемость и подготовлю к контрольной работе, сделаю из него
				отличника! ”
			</>
		),
		social: 'tg',
